...
```
cordova plugin add https://github.com/Qik-Company/cordova-plugin-openwith-v2 --variable IOS_URL_SCHEME=qikmtopenwith --variable IOS_BUNDLE_IDENTIFIER=mt.qik.app
```
